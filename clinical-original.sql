...
IF OBJECT_ID ('TempDb..#Clinical_KPI_Results_Staging1') IS NOT NULL
DROP TABLE #Clinical_KPI_Results_Staging1

Create Table #Clinical_KPI_Results_Staging1
(
Column_Index varchar(25)
,Cell_Data varchar(100)
)
...
insert into #Clinical_KPI_Results_Staging select 'Report_Index', 'S2010'
...
(select	rl.EvalMonth ,Count(rl.EvalMonth) as Cell_Data
	from #Discharge_List rl
	where MoveOut_Category not in ( 'Death' )
 	Group by
	rl.EvalMonth
) r
...
insert into #Clinical_KPI_Results_Staging select 'Report_Index', 'S2015'
insert into #Clinical_KPI_Results_Staging select 'Description', 'Total Discharges - Deaths'
...
--(select	rl.EvalMonth ,Count(rl.EvalMonth) as Cell_Data
--	from #Discharge_List rl
--	join serviceinstance si on rl.thmy = si.carelevelcode where si.carelevelcode in ('AL','PC')
--	and MoveOut_Category = 'Higher LOC' 
-- 	Group by
--	rl.EvalMonth
--) r
...
--insert into #Clinical_KPI_Results_Staging select 'Report_Index', 'S5500'
--insert into #Clinical_KPI_Results_Staging select 'Description', 'Discharges due to Higher Acuity'
...
insert into #Clinical_KPI_Results_Staging select 'Report_Index', 'S3050'
...
insert into #Clinical_KPI_Results_Staging1
select distinct
dl.Column_Index
...
IF OBJECT_ID ('TempDb..#Clinical_KPI_Results_Staging2') IS NOT NULL
DROP TABLE #Clinical_KPI_Results_Staging2

Create Table #Clinical_KPI_Results_Staging2
(
Column_Index varchar(25)
,Cell_Data varchar(100)
)

insert into #Clinical_KPI_Results_Staging2
select distinct dl.Column_Index,cast(r.Cell_Data as Int) as Cell_Data
from
...
insert into #Clinical_KPI_Results_Staging
select distinct #Clinical_KPI_Results_Staging2.Column_Index, (ROUND(cast(#Clinical_KPI_Results_Staging2.Cell_Data as float) 
/ cast(#Clinical_KPI_Results_Staging1.Cell_Data as float),2))*100  as Cell_Data from #Clinical_KPI_Results_Staging2

join #Clinical_KPI_Results_Staging1 on #Clinical_KPI_Results_Staging2.Column_Index 
= #Clinical_KPI_Results_Staging1.Column_Index
--select * from #Clinical_KPI_Results_Staging

--select * from #Incident_List_YTD

/*
	Add Report Index and Row Description
*/

insert into #Clinical_KPI_Results_Staging select 'Report_Index', 'S5010'
...
truncate table #Clinical_KPI_Results_Staging
truncate table #Clinical_KPI_Results_Staging1
truncate table  #Clinical_KPI_Results_Staging2
-------------------------------------------------------------------
...
insert into #Clinical_KPI_Results_Staging select 'Report_Index', 'S5200'
insert into #Clinical_KPI_Results_Staging select 'Description', 'All Therapy'
...
--Total Hospice / Average Daily Census (%)
...
--select * from #Clinical_KPI_Results_Staging2

--select * from #Clinical_KPI_Results_Staging1
...
insert into #Clinical_KPI_Results_Staging select 'Report_Index', 'S4105'
insert into #Clinical_KPI_Results_Staging select 'Description', 'Total Hospice / Total Average Census (%)'
...
update #Clinical_KPI_Results set Report_Index = 'S2015' where Description = 'Total Discharges - Deaths'
...
--update #Clinical_KPI_Results set Report_Index = 'S2050' where Description = 'TEST Discharges due to Higher Acuity'
...
update #Clinical_KPI_Results set Report_Index = 'S5010' where Description = 'Total Fall Incidents/Average Daily Census (%)'
...
update #Clinical_KPI_Results set Report_Index = 'S5200' where Description = 'All Therapy'
...
update #Clinical_KPI_Results set Report_Index = 'S4105' where Description = 'Total Hospice / Total Average Census (%)'
