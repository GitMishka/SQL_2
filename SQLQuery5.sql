...
, (select count(distinct Resident_Name) from #Results_Detail where Report_Index like 'D%' and a.hprop = hprop and  a.Unit_Type = Unit_Type and Unit_Status <> 'R' and movein_date <= GETDATE() ) as Summary_Resident_Count 
...
where uhmy not in (0) and ResStatus in ('Current') and
