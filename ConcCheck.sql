...
insert into @EvalProperties Select 25, 'colm'
/*
...
select distinct(resident_name) from
#Resident_List
where moveout_date is null and movein_date < '2021-12-01 00:00:00.000' and carelevel = 'Concierge' 
order by resident_name asc
select * from #resident_list where resident_name = 'Ingram, Faye' 
and movein_date < '2022-0-01 00:00:00.000' and carelevel = 'Concierge' 
