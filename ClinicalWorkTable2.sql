...
SET @BegMonth = DATEADD(DAY,1,EOMONTH(GETDATE(),-5))
SET @EndMonth = EOMONTH(GETDATE(),-4)
SET @bIncludeSec = 'No'
...
UPDATE #tmpOccupancyResultLocal SET Column_Index = 'Period_1' WhERE PropertyID = @PropCode


/* Period_2 STORE PROC FETCH */
SET @BegMonth = DATEADD(DAY,1,EOMONTH(GETDATE(),-4))
SET @EndMonth = EOMONTH(GETDATE(),-3)
...
UPDATE #tmpOccupancyResultLocal2 SET Column_Index = 'Period_2' WhERE PropertyID = @PropCode


SET @BegMonth = DATEADD(DAY,1,EOMONTH(GETDATE(),-3))
SET @EndMonth = EOMONTH(GETDATE(),-2)
...
UPDATE #tmpOccupancyResultLocal3 SET Column_Index = 'Period_3' WhERE PropertyID = @PropCode

	
/* Period_4 STORE PROC FETCH */
SET @BegMonth = DATEADD(DAY,1,EOMONTH(GETDATE(),-2))
SET @EndMonth = EOMONTH(GETDATE(),-1)
...
UPDATE #tmpOccupancyResultLocal4 SET Column_Index = 'Period_4' WhERE PropertyID = @PropCode

/* Period_5 STORE PROC FETCH */

SET @BegMonth = DATEADD(DAY,1,EOMONTH(GETDATE(),-1))
SET @EndMonth = EOMONTH(GETDATE())
...
UPDATE #tmpOccupancyResultLocal5 SET Column_Index = 'Period_5' WhERE PropertyID = @PropCode

/* Period_6 STORE PROC FETCH */

SET @BegMonth = DATEADD(MONTH, DATEDIFF(MONTH, 0, GETDATE())-1, 0)
SET @EndMonth = DATEADD(MONTH, DATEDIFF(MONTH, -1, GETDATE())-1, -1)
...
UPDATE #tmpOccupancyResultLocal6 SET Column_Index = 'Period_6' WhERE PropertyID = @PropCode
...
FROM #tmpOccupancyResultLocal
INSERT INTO #temp_moveins
SELECT Column_Index,MoveInCount
FROM #tmpOccupancyResultLocal2
INSERT INTO #temp_moveins
SELECT Column_Index,MoveInCount
FROM #tmpOccupancyResultLocal3
INSERT INTO #temp_moveins
SELECT Column_Index,MoveInCount
FROM #tmpOccupancyResultLocal4
INSERT INTO #temp_moveins
SELECT Column_Index,MoveInCount
FROM #tmpOccupancyResultLocal5
INSERT INTO #temp_moveins
SELECT Column_Index,MoveInCount
FROM #tmpOccupancyResultLocal6
