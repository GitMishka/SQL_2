...
SET @wk_startdate = dateadd(mm, datediff(mm, 0, getdate()), 0) --print @wk_startdate
...
insert into #Sales_Goals select 'aths','WK',59,5
insert into #Sales_Goals select 'brwd','WK',59,5
insert into #Sales_Goals select 'calh','WK',59,5
insert into #Sales_Goals select 'cgdl','WK',59,10
...
insert into #Sales_Goals select 'frkl','WK',59,10
insert into #Sales_Goals select 'frkt','WK',59,10
insert into #Sales_Goals select 'frln','WK',59,5
insert into #Sales_Goals select 'grnb','WK',59,10
...
insert into #Sales_Goals select 'knox','WK',59,10
insert into #Sales_Goals select 'knxl','WK',59,10
insert into #Sales_Goals select 'lenc','WK',59,10
insert into #Sales_Goals select 'lenl','WK',59,10
...
insert into #Sales_Goals select 'rusl','WK',59,10
insert into #Sales_Goals select 'russ','WK',59,10
insert into #Sales_Goals select 'sprh','WK',59,10
insert into #Sales_Goals select 'sprl','WK',59,10
   ...
   ON tbl1.hmy = tbl.hmy
	...
	where  
		ph.dtDate  between @wk_startdate and @wk_enddate
	        and sp.sStatus <> 'Referral' and sp.dtFirstContact is not null /*CHANGED: Added no nulls filted on 5-3-2022 */
	...
	left join (
                ...
                from 
                  ...
                  where 
                    ...
                    /* and pa.ActivityCategory in ('TOU','INI') and pa.bUseForReporting = 1 and pa.oldtypecode = 'AT1' */
					and pa.activityname in ('Tour','First Tour', 'Rescheduled Tour')
                  ) sp on p.hMy = sp.hMy
...
/* CHANGED: added secondary tours as seperate line 5-12-2022' */
...
from 
	Property p
	left join #Sales_Goals g on p.scode = g.Community_Code and g.Period = 'WK' and g.Measure = 58
	left join (
      			select
                    p.hMy
                    ,sp.hProperty
                ...
                from 
                  ...
                  where 
                    ph.dtCompleted between @wk_startdate and @wk_enddate
                    and pa.ActivityName in ('Second Tour','Additional Tour(s)', 'Additional Tour')  /*  CHANGED: 2022-05-17 and pa.ActivityCategory in ('TOU','INI') and pa.bUseForReporting = 1 and pa.oldtypecode = 'AT2' */
                  ) sp on p.hMy = sp.hMy
...
from 
	Property p
	left join #Sales_Goals g on p.scode = g.Community_Code and g.Period = 'MTD' and g.Measure = 58
	left join (
      			select
                    p.hMy
                    ,sp.hProperty
...
from 
	Property p
	left join #Sales_Goals g on p.scode = g.Community_Code and g.Period = 'LM' and g.Measure = 58
	left join (
      			select
                    p.hMy
                    ,sp.hProperty
	...
	left join (
		...
		from 
			...
			left join SeniorProspect sp on sp.hMy = ph.hProspect
                ...
                where 
                ph.dtCompleted between @wk_startdate and @wk_enddate
                /* and pa.ActivityCategory in ('NRF') Taken out 2022-05-17 */ 
	...
	left join (
		...
		from 
			...
			left join SeniorProspect sp on sp.hMy = ph.hProspect
                ...
                where 
                ph.dtCompleted between @wk_startdate and @wk_enddate
            	/* and pa.ActivityCategory in ('ERA') Taken out 2022-05-17
				and sp.sStatus = 'Referral'  */ 
...
/*CHANGED: Added SalesMail line 5-12-2022' */

/*
	Week Completed SalesMail
*/
...
from 
	Property p
	left join #Sales_Goals g on p.scode = g.Community_Code and g.Period = 'WK' and g.Measure = 59
	left join (
 		select 
			p.hMy
			,sp.hProperty
...
from 
	Property p
	left join #Sales_Goals g on p.scode = g.Community_Code and g.Period = 'MTD' and g.Measure = 59
	left join (
 		select 
			p.hMy
			,sp.hProperty
...
from 
	Property p
	left join #Sales_Goals g on p.scode = g.Community_Code and g.Period = 'LM' and g.Measure = 59
	left join (
 		select 
			p.hMy
			,sp.hProperty
...
/*CHANGED: End of SalesMale lines */
/*
	Weekly Deposits
*/
...
set count = case 
	...
	/* CHANGED: added Sales Mail 2022-05-16 */
	when hprop in (31,32) and measure = 59 and period = 'LM' then (select sum(count) from #Count_Backup where hprop in (31,32) and measure = 59 and period = 'LM')
	when hprop in (31,32) and measure = 59 and period = 'MTD' then (select sum(count) from #Count_Backup where hprop in (31,32) and measure = 59 and period = 'MTD')
	when hprop in (31,32) and measure = 59 and period = 'WK' then (select sum(count) from #Count_Backup where hprop in (31,32) and measure = 59 and period = 'WK')	
	...
	when hprop in (26,27) and measure = 20 and period = 'WK' then (select sum(count) from #Count_Backup where hprop in (26,27) and measure = 20 and period = 'WK')	
		/* CHANGED: added Sales Mail 2022-05-16 */
	when hprop in (26,27) and measure = 59 and period = 'LM' then (select sum(count) from #Count_Backup where hprop in (26,27) and measure = 59 and period = 'LM')
	when hprop in (26,27) and measure = 59 and period = 'MTD' then (select sum(count) from #Count_Backup where hprop in (26,27) and measure = 59 and period = 'MTD')
	when hprop in (26,27) and measure = 59 and period = 'WK' then (select sum(count) from #Count_Backup where hprop in (26,27) and measure = 59 and period = 'WK')	
	...
	/* CHANGED: added Sales Mail 2022-05-16 */
	when hprop in (13,52) and measure = 59 and period = 'LM' then (select sum(count) from #Count_Backup where hprop in (13,52) and measure = 59 and period = 'LM')
	when hprop in (13,52) and measure = 59 and period = 'MTD' then (select sum(count) from #Count_Backup where hprop in (13,52) and measure = 59 and period = 'MTD')
	when hprop in (13,52) and measure = 59 and period = 'WK' then (select sum(count) from #Count_Backup where hprop in (13,52) and measure = 59 and period = 'WK')
...
*/
	...
	/* CHANGED: added Sales Mail 2022-05-16 */
	when hprop in (24,29) and measure = 59 and period = 'WK' then (select sum(count) from #Count_Backup where hprop in (24,29) and measure = 59 and period = 'WK')	
	when hprop in (24,29) and measure = 59 and period = 'LM' then (select sum(count) from #Count_Backup where hprop in (24,29) and measure = 59 and period = 'LM')
	when hprop in (24,29) and measure = 59 and period = 'MTD' then (select sum(count) from #Count_Backup where hprop in (24,29) and measure = 59 and period = 'MTD')
	...
	/* CHANGED: added Sales Mail 2022-05-16 */
	when hprop in (79,80) and measure = 59 and period = 'WK' then (select sum(count) from #Count_Backup where hprop in (79,80) and measure = 59 and period = 'WK')	
	when hprop in (79,80) and measure = 59 and period = 'LM' then (select sum(count) from #Count_Backup where hprop in (79,80) and measure = 59 and period = 'LM')
	when hprop in (79,80) and measure = 59 and period = 'MTD' then (select sum(count) from #Count_Backup where hprop in (79,80) and measure = 59 and period = 'MTD')
	...
	when hprop in (4,5) and measure = 20 and period = 'WK' then (select sum(count) from #Count_Backup where hprop in (4,5) and measure = 20 and period = 'WK')	
	/* CHANGED: added Sales Mail 2022-05-16 */
	when hprop in (4,5) and measure = 59 and period = 'WK' then (select sum(count) from #Count_Backup where hprop in (4,5) and measure = 59 and period = 'WK')	
	when hprop in (4,5) and measure = 59 and period = 'MTD' then (select sum(count) from #Count_Backup where hprop in (4,5) and measure = 59 and period = 'MTD')
	when hprop in (4,5) and measure = 59 and period = 'LM' then (select sum(count) from #Count_Backup where hprop in (4,5) and measure = 59 and period = 'LM')
	...
	/* CHANGED: added Sales Mail 2022-05-16 */
	when hprop in (12,61) and measure = 59 and period = 'WK' then (select sum(count) from #Count_Backup where hprop in (12,61) and measure = 59 and period = 'WK')	
	when hprop in (12,61) and measure = 59 and period = 'MTD' then (select sum(count) from #Count_Backup where hprop in (12,61) and measure = 59 and period = 'MTD')
	when hprop in (12,61) and measure = 59 and period = 'LM' then (select sum(count) from #Count_Backup where hprop in (12,61) and measure = 59 and period = 'LM')
	...
	/* CHANGED: added Sales Mail 2022-05-16 */
	when hprop in (63,65) and measure = 59 and period = 'WK' then (select sum(count) from #Count_Backup where hprop in (63,65) and measure = 59 and period = 'WK')
	when hprop in (63,65) and measure = 59 and period = 'LM' then (select sum(count) from #Count_Backup where hprop in (63,65) and measure = 59 and period = 'LM')
	when hprop in (63,65) and measure = 59 and period = 'MTD' then (select sum(count) from #Count_Backup where hprop in (63,65) and measure = 59 and period = 'MTD')
	...
	when hprop in (11,76) and measure = 20 and period = 'WK' then (select sum(count) from #Count_Backup where hprop in (11,76) and measure = 20 and period = 'WK')
		/* CHANGED: added Sales Mail 2022-05-16 */
	when hprop in (11,76) and measure = 59 and period = 'WK' then (select sum(count) from #Count_Backup where hprop in (11,76) and measure = 59 and period = 'WK')
	when hprop in (11,76) and measure = 59 and period = 'LM' then (select sum(count) from #Count_Backup where hprop in (11,76) and measure = 59 and period = 'LM')
	when hprop in (11,76) and measure = 59 and period = 'MTD' then (select sum(count) from #Count_Backup where hprop in (11,76) and measure = 59 and period = 'MTD')
...
*/
	...
	,case
		...
		when kpi.Period in ('WK','MTD') and kpi.Measure =10 and (isnull(kpi.Count* 1.00000,0) / isnull(kpi.Goal* 1.00000,0)) > 1.25000 then .1 * 1.25000 
		when kpi.Period in ('WK','MTD') and kpi.Measure =20 and (isnull(kpi.Count* 1.00000,0) / isnull(kpi.Goal* 1.00000,0)) > 1.25000 then .25 * 1.25000 
		when kpi.Period in ('WK','MTD') and kpi.Measure =30 and (isnull(kpi.Count* 1.00000,0) / isnull(kpi.Goal* 1.00000,0)) > 1.25000 then .35 * 1.25000 
		when kpi.Period in ('WK','MTD') and kpi.Measure =40 and (isnull(kpi.Count* 1.00000,0) / isnull(kpi.Goal* 1.00000,0)) > 1.25000 then .1 * 1.25000 
		when kpi.Period in ('WK','MTD') and kpi.Measure =50 and (isnull(kpi.Count* 1.00000,0) / isnull(kpi.Goal* 1.00000,0)) > 1.25000 then .15 * 1.25000 
		when kpi.Period in ('WK','MTD') and kpi.Measure =59 and (isnull(kpi.Count* 1.00000,0) / isnull(kpi.Goal* 1.00000,0)) > 1.25000 then .05 * 1.25000 /*CHANGED: Added calculation for measure 59 05-13-2022 */
		...
		when kpi.Period in ('WK','MTD') and kpi.Measure =10 then round((isnull(kpi.Count* 1.00000,0) / isnull(kpi.Goal* 1.00000,0)),2) * .1 
		when kpi.Period in ('WK','MTD') and kpi.Measure =20 then round((isnull(kpi.Count* 1.00000,0) / isnull(kpi.Goal* 1.00000,0)),2) * .25
		when kpi.Period in ('WK','MTD') and kpi.Measure =30 then round((isnull(kpi.Count* 1.00000,0) / isnull(kpi.Goal* 1.00000,0)),2) * .35 
		when kpi.Period in ('WK','MTD') and kpi.Measure =40 then round((isnull(kpi.Count* 1.00000,0) / isnull(kpi.Goal* 1.00000,0)),2) * .1 
		when kpi.Period in ('WK','MTD') and kpi.Measure =50 then round((isnull(kpi.Count* 1.00000,0) / isnull(kpi.Goal* 1.00000,0)),2) * .15 
		when kpi.Period in ('WK','MTD') and kpi.Measure =59 then round((isnull(kpi.Count* 1.00000,0) / isnull(kpi.Goal* 1.00000,0)),2) * .05 /*CHANGED: Added calculation for measure 59 05-13-2022 */
		...
		when kpi.Period = 'LM' and kpi.Measure =10 and (isnull(kpi.Count* 1.00000,0) / isnull(kpi.Goal* 1.00000,0)) > 1.25000 then .1 * 1.25000 
		when kpi.Period = 'LM' and kpi.Measure =20 and (isnull(kpi.Count* 1.00000,0) / isnull(kpi.Goal* 1.00000,0)) > 1.25000 then .25 * 1.25000 
		when kpi.Period = 'LM' and kpi.Measure =30 and (isnull(kpi.Count* 1.00000,0) / isnull(kpi.Goal* 1.00000,0)) > 1.25000 then .35 * 1.25000 
		when kpi.Period = 'LM' and kpi.Measure =40 and (isnull(kpi.Count* 1.00000,0) / isnull(kpi.Goal* 1.00000,0)) > 1.25000 then .1 * 1.25000 
		when kpi.Period = 'LM' and kpi.Measure =50 and (isnull(kpi.Count* 1.00000,0) / isnull(kpi.Goal* 1.00000,0)) > 1.25000 then .15 * 1.25000 
		when kpi.Period = 'LM' and kpi.Measure =59 and (isnull(kpi.Count* 1.00000,0) / isnull(kpi.Goal* 1.00000,0)) > 1.25000 then .05 * 1.25000  /*CHANGED: Added calculation for measure 59 05-13-2022 */
		...
		when kpi.Period = 'LM' and kpi.Measure =10 then round((isnull(kpi.Count* 1.00000,0) / isnull(kpi.Goal* 1.00000,0)),2) * .1 
		when kpi.Period = 'LM' and kpi.Measure =20 then round((isnull(kpi.Count* 1.00000,0) / isnull(kpi.Goal* 1.00000,0)),2) * .25 
		when kpi.Period = 'LM' and kpi.Measure =30 then round((isnull(kpi.Count* 1.00000,0) / isnull(kpi.Goal* 1.00000,0)),2) * .35 
		when kpi.Period = 'LM' and kpi.Measure =40 then round((isnull(kpi.Count* 1.00000,0) / isnull(kpi.Goal* 1.00000,0)),2) * .1 
		when kpi.Period = 'LM' and kpi.Measure =50 then round((isnull(kpi.Count* 1.00000,0) / isnull(kpi.Goal* 1.00000,0)),2) * .15 
		when kpi.Period = 'LM' and kpi.Measure =59 then round((isnull(kpi.Count* 1.00000,0) / isnull(kpi.Goal* 1.00000,0)),2) * .05 /*CHANGED: Added calculation for measure 59 05-13-2022 */ 
...
/*
	Prepare Report Index C:\Users\Administrator\Desktop\pak-files\unpack - Community Weekly Activities
*/
...
DROP TABLE IF EXISTS #bitest --added
...
--and community like '%powl%' 
and period in ('MTD')
--('WK')--, 'MTD')
/*

and measure = 10 and period = 'LM'
and Measure_Desc = 'Sales Calls - Existing Referrals (in person only)' and kpi.hprop = 20
and Measure_Desc = 'Second Tours'
and measure in (10,20,30,40,50)
and measure = 59 and period = 'LM'
...
--select * from #bitest
select measure_desc,sum(count) from #bitest
where community_abbr = 'Russell'
